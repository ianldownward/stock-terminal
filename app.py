...
def get_directives():
    ...
    for t in scan_list:
        ...
        try:
            ...
            # EMERGENCY KILL SWITCH: Auto-trading completely disabled
            is_auto = False 
